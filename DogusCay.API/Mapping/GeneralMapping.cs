...
namespace DogusCay.API.Mapping
{
    public class GeneralMapping : Profile
    {
        public GeneralMapping()
        {
            ...
            CreateMap<TalepForm, ResultTalepFormDto>()
                // Kanal zinciri
                .ForMember(dest => dest.KanalName,
                    opt => opt.MapFrom(src => src.Kanal != null ? src.Kanal.KanalName : null))
                .ForMember(dest => dest.DistributorName,
                    opt => opt.MapFrom(src => src.Distributor != null ? src.Distributor.DistributorName : null))
                .ForMember(dest => dest.PointGroupTypeName,
                    opt => opt.MapFrom(src => src.PointGroupType != null ? src.PointGroupType.PointGroupTypeName : null))
                .ForMember(dest => dest.PointName,
                    opt => opt.MapFrom(src => src.Point != null ? src.Point.PointName : null))
                // Kullanıcı bilgisi
                .ForMember(dest => dest.UserFullName,
                    opt => opt.MapFrom(src => src.AppUser != null
                ...
                .ForMember(dest => dest.SubSubCategoryName,
                    opt => opt.MapFrom(src => src.SubSubCategory != null ? src.SubSubCategory.CategoryName : null));

            CreateMap<TalepForm, ExportTalepFormDto>().ReverseMap();

            // MAL YÜKLEME TALEP FORMLARI
            CreateMap<CreateMalYuklemeTalepFormDto, MalYuklemeTalepForm>().ReverseMap();
            CreateMap<CreateMalYuklemeTalepFormDetailDto, MalYuklemeTalepFormDetail>().ReverseMap();
